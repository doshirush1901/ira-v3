#!/usr/bin/env python3
"""Send Lead 20 (Lee Chun Yuan, Plastic Alloy Products Malaysia) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead20_lee_chun_yuan_TO_SEND.md"

SUBJECT_NEW = "Your 2000×2500 thermoforming inquiry — Plastic Alloy Products and an offer"
TO_EMAIL = "plasticalloyproducts@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Lee Chun Yuan,")
    if start == -1:
        return text
    rest = text[start:]
