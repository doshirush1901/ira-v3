#!/usr/bin/env python3
"""Send Lead 40 (Edward Otieno, dwardi studios limited) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead40_edward_otieno_TO_SEND.md"

SUBJECT_NEW = "dwardi studios — catching up on your thermoforming inquiry"
TO_EMAIL = "edstudios88@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Edward,")
    if start == -1:
        return text
    rest = text[start:]
