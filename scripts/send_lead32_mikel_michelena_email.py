#!/usr/bin/env python3
"""Send Lead 32 (Mikel, Michelena) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead32_mikel_michelena_TO_SEND.md"

SUBJECT_NEW = "Your 800×1000 thermoforming inquiry — Michelena"
TO_EMAIL = "mikelgonzalez90@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Mikel,")
    if start == -1:
        return text
    rest = text[start:]
