#!/usr/bin/env python3
"""Send Lead 29 (Mohammed Abdul Fazil) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead29_mohammed_abdul_fazil_TO_SEND.md"

SUBJECT_NEW = "Your 2000×4500 thermoforming inquiry — what happened next?"
TO_EMAIL = "mafazil0321@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Mohammed,")
    if start == -1:
        return text
    rest = text[start:]
