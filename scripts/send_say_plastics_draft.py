#!/usr/bin/env python3
"""Send SAY Plastics draft as a new email thread. Requires API server running and IRA_EMAIL_MODE=OPERATIONAL for send."""
...
DRAFT_PATH = Path(__file__).resolve().parents[1] / "data" / "knowledge" / "draft_email_say_plastics.md"
API_URL = "http://localhost:8000/api/email/send"

SUBJECT = "Reconnecting — new capacity, a couple of options, and one bad joke"
TO = "lsmith@sayplastics.com"
