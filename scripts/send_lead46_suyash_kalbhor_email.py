#!/usr/bin/env python3
"""Send Lead 46 (Suyash Kalbhor, Ather Energy) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead46_suyash_kalbhor_TO_SEND.md"

SUBJECT_NEW = "Ather Energy — catching up on automotive thermoforming (and two machine options)"
TO_EMAIL = "suyash.kalbhor@atherenergy.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Suyash,")
    if start == -1:
        return text
    rest = text[start:]
