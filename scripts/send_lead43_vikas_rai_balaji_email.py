#!/usr/bin/env python3
"""Send Lead 43 (Vikas Rai, Balaji Rubber Products) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead43_vikas_rai_balaji_TO_SEND.md"

SUBJECT_NEW = "Balaji Rubber — catching up on automotive thermoforming (and two machine options)"
TO_EMAIL = "balaji.products08@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Vikas,")
    if start == -1:
        return text
    rest = text[start:]
