#!/usr/bin/env python3
"""Send Plastoform draft as a new email thread. Requires API server running and IRA_EMAIL_MODE=OPERATIONAL for send."""
...
DRAFT_PATH = Path(__file__).resolve().parents[1] / "data" / "knowledge" / "draft_email_plastoform.md"
API_URL = "http://localhost:8000/api/email/send"

SUBJECT = "How are you? (and a few things that might be useful)"
TO = "peterg@plastoform.si"
