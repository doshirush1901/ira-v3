#!/usr/bin/env python3
"""Send Lead 42 (sahithi chekuri, AMTZ) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead42_sahithi_amtz_TO_SEND.md"

SUBJECT_NEW = "AMTZ — catching up on medical device enclosures (and two machine options)"
TO_EMAIL = "sahithi.ch@amtz.in"


def extract_body(text: str) -> str:
    start = text.find("Hi Sahithi,")
    if start == -1:
        return text
    rest = text[start:]
