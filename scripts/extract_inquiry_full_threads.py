#!/usr/bin/env python3
"""
Extract FULL conversation threads from the founder's mailbox for Inquiry Form leads.
        ...
        try:
            ...
            for thread_info in threads:
                ...
                if len(thread_messages) >= 2:  # Need at least 2 messages
                    # Separate customer and founder messages
...
def extract_pairs_from_thread(messages, lead_email):
    ...
    # Match customer questions with the founder's responses
    ...
    for i, msg in enumerate(all_msgs):
        ...
        # If this is a customer message, look for the founder's next response
        if lead_email.lower() in from_addr:
            # Find next message from the founder
