#!/usr/bin/env python3
"""Send Lead 38 (Ian Martinez, Toyota Gibraltar Stockholding Ltd.) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead38_darell_cavilla_TO_SEND.md"

SUBJECT_NEW = "Catching up — Toyota Gibraltar (and a 6.5×2 m story we just shared)"
TO_EMAIL = "Ian.Martinez@toyota-gib.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Ian,")
    if start == -1:
        return text
    rest = text[start:]
