#!/usr/bin/env python3
"""Send Lead 39 (David Rojas Caballero, T-CASE) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead39_david_rojas_tcase_TO_SEND.md"

SUBJECT_NEW = "T-CASE — catching up on that 3×4 m idea (and the industry)"
TO_EMAIL = "tcase.tecnologias@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi David,")
    if start == -1:
        return text
    rest = text[start:]
