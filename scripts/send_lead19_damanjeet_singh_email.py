#!/usr/bin/env python3
"""Send Lead 19 (Damanjeet Singh, Pali plast india) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead19_damanjeet_singh_TO_SEND.md"

SUBJECT_NEW = "Your 1000×1000 thermoforming inquiry — Pali plast india and an offer in INR"
TO_EMAIL = "Damanjeetsingh24@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Damanjeet,")
    if start == -1:
        return text
    rest = text[start:]
