#!/usr/bin/env python3
"""Send Lead 28 (Jim Biberias, VACMOULD DISPLAYS) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead28_jim_biberias_TO_SEND.md"

SUBJECT_NEW = "Quick catch-up — how are you, and our new 6×2 m (XL) at Dutch Tides"
TO_EMAIL = "jim@vacmoulddisplays.com.au"


def extract_body(text: str) -> str:
    start = text.find("Hi Jim,")
    if start == -1:
        return text
    rest = text[start:]
