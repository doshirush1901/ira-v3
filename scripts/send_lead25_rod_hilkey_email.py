#!/usr/bin/env python3
"""Send Lead 25 (Rod Hilkey, KLX Energy Services) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead25_rod_hilkey_TO_SEND.md"

SUBJECT_NEW = "Your 2500×4500 thermoforming inquiry — picking up where we left off"
TO_EMAIL = "rhilkey@klxenergys.com"


def extract_body(text: str) -> str:
    start = text.find("Hey Rod,")
    if start == -1:
        return text
    rest = text[start:]
