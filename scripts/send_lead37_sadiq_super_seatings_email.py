#!/usr/bin/env python3
"""Send Lead 37 (Sadiq Hassain Ali, Super seatings) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead37_sadiq_super_seatings_TO_SEND.md"

SUBJECT_NEW = "Super seatings — catching up on automotive & TPE, and a quick chat?"
TO_EMAIL = "adamjeeco@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Sadiq,")
    if start == -1:
        return text
    rest = text[start:]
