#!/usr/bin/env python3
"""Send Lead 48 (Marc Canudas, WORLDMAQ 3 S.L. / BERMAQ) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead48_marc_canudas_TO_SEND.md"

SUBJECT_NEW = "BERMAQ — catching up, and how's the client's decision going?"
TO_EMAIL = "mcanudas@bermaq.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Marc,")
    if start == -1:
        return text
    rest = text[start:]
