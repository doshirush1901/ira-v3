#!/usr/bin/env python3
"""Send Lead 15 (Michaal K, Austin Parts Kenya) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead15_michaal_austin_TO_SEND.md"

SUBJECT_NEW = "Austin Parts — your thermoforming inquiry and an offer for automotive ABS"
TO_EMAIL = "michael@austin.co.ke"


def extract_body(text: str) -> str:
    start = text.find("Hi Michael,")
    if start == -1:
        return text
    rest = text[start:]
