#!/usr/bin/env python3
"""Send Lead 41 (Steven Kimpton, Consort) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead41_steven_kimpton_TO_SEND.md"

SUBJECT_NEW = "Consort — catching up, and is the 2×3 m project still on?"
TO_EMAIL = "steven@consortcases.ie"


def extract_body(text: str) -> str:
    start = text.find("Hi Steven,")
    if start == -1:
        return text
    rest = text[start:]
