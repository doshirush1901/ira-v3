#!/usr/bin/env python3
"""Send Plastikabalumag draft as a new email thread. Requires API server running and IRA_EMAIL_MODE=OPERATIONAL for send."""
...
DRAFT_PATH = Path(__file__).resolve().parents[1] / "data" / "knowledge" / "draft_email_patrick_gygax_plastikabalumag.md"
API_URL = "http://localhost:8000/api/email/send"

SUBJECT = "What's new with you? Three options (lab, IMG, Dezet) — and one bad joke"
TO = "patrick.gygax@plastikabalumag.ch"
CC = "Martin.Buetler@plastikabalumag.ch"
