#!/usr/bin/env python3
"""Send Lead 21 (Mustapha Hadjri, Ekoless, Algeria) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead21_mustapha_hadjri_TO_SEND.md"

SUBJECT_NEW = "Your 2500×2500 thermoforming inquiry — Algeria and an offer"
TO_EMAIL = "ekoless.dz@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Mustapha,")
    if start == -1:
        return text
    rest = text[start:]
