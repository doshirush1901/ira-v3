#!/usr/bin/env python3
"""Send Lead 49 (Randolph Crasto, IHT Group) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead49_randolph_crasto_TO_SEND.md"

SUBJECT_NEW = "IHT Group — catching up on your thermoforming inquiry"
TO_EMAIL = "rcrasto@ihtgroup.ca"


def extract_body(text: str) -> str:
    start = text.find("Hi Randolph,")
    if start == -1:
        return text
    rest = text[start:]
