#!/usr/bin/env python3
"""Send Lead 31 (Sergey Klaypnev, AO SAPT) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead31_sergey_klaypnev_TO_SEND.md"

SUBJECT_NEW = "AO SAPT — catch-up, your two machines, and what's new"
TO_EMAIL = "sapt@sapt.ru"


def extract_body(text: str) -> str:
    start = text.find("Dear Sergey,")
    if start == -1:
        return text
    rest = text[start:]
