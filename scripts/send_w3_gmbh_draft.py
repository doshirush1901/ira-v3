#!/usr/bin/env python3
"""Send W3 GmbH draft as a new email thread. Requires API server running and IRA_EMAIL_MODE=OPERATIONAL for send."""
...
DRAFT_PATH = Path(__file__).resolve().parents[1] / "data" / "knowledge" / "draft_email_w3_gmbh.md"
API_URL = "http://localhost:8000/api/email/send"

SUBJECT = "Reconnecting — how are you? (and a few things that might be useful)"
TO = "wolfgang.boehringer@w3-gmbh.com"
