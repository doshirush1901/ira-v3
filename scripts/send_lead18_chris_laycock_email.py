#!/usr/bin/env python3
"""Send Lead 18 (Chris Laycock, Australia) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead18_chris_laycock_TO_SEND.md"

SUBJECT_NEW = "Your 2000×4500 thermoforming inquiry — quick catch-up and offer"
TO_EMAIL = "cjlaycock@iinet.net.au"


def extract_body(text: str) -> str:
    start = text.find("Hi Chris,")
    if start == -1:
        return text
    rest = text[start:]
