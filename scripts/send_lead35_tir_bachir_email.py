#!/usr/bin/env python3
"""Send Lead 35 (Tir Bachir, sarl freres tir) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead35_tir_bachir_TO_SEND.md"

SUBJECT_NEW = "sarl freres tir — catch-up, 2000×2000, and a web call next week?"
TO_EMAIL = "freretir@yahoo.fr"


def extract_body(text: str) -> str:
    start = text.find("Hi Tir,")
    if start == -1:
        return text
    rest = text[start:]
