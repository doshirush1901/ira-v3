#!/usr/bin/env python3
"""Send Feltol draft as a new email thread. Requires API server running and IRA_EMAIL_MODE=OPERATIONAL for send."""
...
DRAFT_PATH = Path(__file__).resolve().parents[1] / "data" / "knowledge" / "draft_email_feltol.md"
API_URL = "http://localhost:8000/api/email/send"

SUBJECT = "Reconnecting — 1-pager + videos (and a few questions)"
TO = "teera@feltol.co.th"
