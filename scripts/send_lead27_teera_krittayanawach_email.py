#!/usr/bin/env python3
"""Send Lead 27 (Teera Krittayanawach, Feltol) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead27_teera_krittayanawach_TO_SEND.md"

SUBJECT_NEW = "Feltol — your 1000×1500 thermoforming project, and the 1-pager + video"
TO_EMAIL = "teera@feltol.co.th"


def extract_body(text: str) -> str:
    start = text.find("Hi Teera,")
    if start == -1:
        return text
    rest = text[start:]
