#!/usr/bin/env python3
"""Send Lead 24 (Rémi Gauthier, Produits Proflex) email to work address."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead24_remi_gauthier_TO_SEND.md"

SUBJECT_NEW = "Quick hello — how's the PF1-C-0913, and those numbers you'd asked for"
TO_EMAIL = "r.gauthier@produitsproflex.com"


def extract_body(text: str) -> str:
    start = text.find("Hey Rémi,")
    if start == -1:
        return text
    rest = text[start:]
