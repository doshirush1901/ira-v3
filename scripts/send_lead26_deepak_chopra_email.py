#!/usr/bin/env python3
"""Send Lead 26 (Deepak Chopra) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead26_deepak_chopra_TO_SEND.md"

SUBJECT_NEW = "Your 2000×2500 thermoforming inquiry — quick catch-up"
TO_EMAIL = "deepak.chopra1772@gmail.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Deepak,")
    if start == -1:
        return text
    rest = text[start:]
