#!/usr/bin/env python3
"""Send Lead 23 (Shawn Decoste, A4 CPM) email as new message."""
...
TO_SEND = PROJECT_ROOT / "data/imports/24_WebSite_Leads/email_lead23_shawn_decoste_TO_SEND.md"

SUBJECT_NEW = "Your 2000×3000 thermoforming inquiry — indoor farming and a fit that might help"
TO_EMAIL = "sdecoste@a4cpm.com"


def extract_body(text: str) -> str:
    start = text.find("Hi Shawn,")
    if start == -1:
        return text
    rest = text[start:]
