...
Usage:
    ...
    context = get_cross_channel_context(
        channel="telegram",
        identifier="5700751574"  # Telegram chat ID
    )
                        ...
                        try:
                            ...
                            if ts_str:
                                try:
                                    ...
                                    logger.error(f"Error in get_email_threads_for_contact: {e}", exc_info=True)
                ...
                for entry in data:
                    ...
                    if ts_str:
                        try:
                            ...
                            logger.error(f"Error in get_telegram_messages_for_chat: {e}", exc_info=True)
...
if __name__ == "__main__":
    ...
    if args.telegram:
        ...
        print("Usage:")
        print("  python cross_channel_context.py --telegram 5700751574")
