...
Usage:
    ...
    email = campaign.get_next_email("eu-012")  # European Lead #12
...
IRA_INTRODUCTION = """I'm Ira, Machinecraft's sales assistant. I work alongside the founder to help \
...
give you quick answers and put together quotes. The founder oversees everything and \
...
IRA_INTRODUCTION_SHORT = """I'm Ira, Machinecraft's sales assistant. I work with the founder to help \
thermoforming companies find the right machines. I can answer questions, share specs, and put \
together quotes - the founder handles the final details."""

IRA_INTRODUCTION_MINIMAL = """I'm Ira, working with the founder at Machinecraft. I'm here to help \
...
class LeadPriority(Enum):
    ...
    CRITICAL = "critical"   # Immediate action (high-priority leads)
...
CRITICAL_TEMPLATES = {
    "European Vehicle Converter": {
        CampaignStage.INTRO: """Dear {{contact_name}},

Congratulations on your company's major expansion — the investment in your new international facility is impressive news.
...
Given your timeline for the new facility, I wanted to reach out immediately to offer:

• Complete machine + router + tooling packages
• Identical equipment for both plants (process consistency)
• Support infrastructure for international operations
• Competitive pricing that makes sense for your growth phase

Your vehicle conversion expertise combined with Machinecraft's thermoforming solutions could be a powerful match.
...
+91 98XXX XXXXX""",
    ...
    "French Aerospace Thermoformer": {
        CampaignStage.INTRO: """Dear {contact_name},

I saw the news about your company's factory extension — congratulations on the growth. With 50+ years of aerospace thermoforming expertise, you're clearly at the forefront of the industry.
...
class EuropeanDripCampaign:
    ...
    def _load_state(self) -> Dict[str, CampaignLead]:
        ...
        try:
            ...
            logger.error(f"Error in _load_state: {e}", exc_info=True)
        return state
